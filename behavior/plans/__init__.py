...
LEFT_CHILD_PLAN_NODE_ID_SCHEMA_INDEX = DIFFERENCING_SCHEMA_WITH_TARGETS.index("left_child_plan_node_id")
RIGHT_CHILD_PLAN_NODE_ID_SCHEMA_INDEX = DIFFERENCING_SCHEMA_WITH_TARGETS.index("right_child_plan_node_id")
TARGET_START_SCHEMA_INDEX = DIFFERENCING_SCHEMA_WITH_TARGETS.index("total_cost")
